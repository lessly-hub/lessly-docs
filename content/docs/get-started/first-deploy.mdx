...
The agent calls `lessly_create_deployment`. It reads your repo, detects Next.js, picks the right build command, and starts the deploy. You will see the agent stream status updates as the build runs.
